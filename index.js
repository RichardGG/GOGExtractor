...
function updateGogGames() {
    ...
    // TODO get gamePieceTypes and update query with correct values
    ...
    `SELECT 
        ...
        group_concat(myFriendsActivity) as myFriendsActivity,
        group_concat(friendsOwning) as friendsOwning,
        tags,
    ...
    FROM (SELECT GamePieces.releaseKey, -- This query groups all gamePieces by releaseKey
        (case when gamePieceTypeId = 1 then value end) as myRating,
        (case when gamePieceTypeId = 294 then value end) as sortingTitle,
        (case when gamePieceTypeId = 295 then value end) as title,
        (case when gamePieceTypeId = 873 then value end) as allGameReleases,
        (case when gamePieceTypeId = 874 then value end) as dlcs,
        (case when gamePieceTypeId = 875 then value end) as media,
        (case when gamePieceTypeId = 876 then value end) as originalImages,
        (case when gamePieceTypeId = 877 then value end) as originalMeta,
        (case when gamePieceTypeId = 878 then value end) as originalSortingTitle,
        (case when gamePieceTypeId = 879 then value end) as originalTitle,
        (case when gamePieceTypeId = 880 then value end) as myAchievementsCount,
        (case when gamePieceTypeId = 1256 then value end) as osCompatibility,
        (case when gamePieceTypeId = 1292 then value end) as meta,
        (case when gamePieceTypeId = 1298 then value end) as summary,
        (case when gamePieceTypeId = 12310 then value end) as changelog,
        (case when gamePieceTypeId = 12311 then value end) as goodies,
        (case when gamePieceTypeId = 12312 then value end) as isPreorder,
        (case when gamePieceTypeId = 12313 then value end) as productLinks,
        (case when gamePieceTypeId = 12605 then value end) as myFriendsActivity,
        (case when gamePieceTypeId = 12606 then value end) as friendsOwning
